...
class RectangularRoom(object):
    ...
    def cleanTileAtPosition(self, pos):
        ...
        #let's find where is this in terms of tile (_,_)
        self.cleantiles.add((int(x),int(y)))
    ...
    def getRandomPosition(self):
        ...
        """
        x=random.uniform(0,self.width-0.1);y=random.uniform(0,self.height-0.1)
        return Position(x,y)
...
class Robot(object):
    ...
    def getRobotPosition(self):
        ...
        """
        #return self.room.getRandomPosition()
...
class StandardRobot(Robot):
    ...
    def updatePositionAndClean(self):
        ...
        olddirection = self.getRobotDirection()
        newposition = oldposition.getNewPosition(olddirection, self.speed)
...
def runSimulation(num_robots, speed, width, height, min_coverage, num_trials,
    ...
    for _ in range(num_trials):
        ...
        step = 0
        coverage = room.getNumCleanedTiles()/totaltiles
...
#       (... your call here ...)
#
#showPlot1('Firstplot', 'num_robot', 'time')
#
...
#       (... your call here ...)
#
showPlot2('Secondplot', 'aspect_ratio', 'time')